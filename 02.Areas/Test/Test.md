...
- 定義:在軟體正式發佈之前,讓一部分目標使用者在真實環境下測試使用的最後測試階段
- 測試對象:測試版軟體,大部分功能已完成,存在一些已知未解決問題
- 測試人員:來自目標使用者群的志願者
- 測試環境:類似實際使用環境
- 測試目標:發現終端使用者使用中可能出現的問題,改進軟體易用性
- 測試時間:功能測試之後,正式發佈之前
- 測試報告:測試人員提交問題報告、建議等
8. 結果處理:開發團隊分類、解決報告中的問題,完善軟體
9. 迭代次數:通常至少1次,根據需要可以多次迭代測試
10. 移交下階段:測試結束,解決重大問題後,移交到正式發佈階段
