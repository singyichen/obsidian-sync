...
### 測試內容
- 軟體的業務功能、介面功能、安全功能等。
### 常用測試方法:黑盒測試、白盒測試、自動化測試等。
4. 測試目的:驗證各功能按需求設計運行,找出功能缺陷。
5. 測試基準:與軟體需求規格進行符合性對比。
6. 測試角色:開發人員、測試人員、業務人員。
7. 測試重點:軟體主流程、邊界條件、異常案例。
8. 典型缺陷:介面錯誤、演算法錯誤、相容性問題。
9. 結果處理:記錄缺陷,開發人員進行修改。
10. 移交測試:功能測試結束後移交系統測試。
