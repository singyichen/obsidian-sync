...
### 測試內容:軟硬體功能、性能、安全性、可靠性、可用性等。
3. 常用測試方法:整體回歸測試、壓力測試、容量測試等。
4. 測試目的:確保系統按需求設計運行,可靠及穩定。
5. 測試角色:測試人員、開發人員、業務人員。
6. 測試重點:核心功能的正確性、性能指標。
7. 典型缺陷:整體性能低下、系統崩潰、數據錯誤。
8. 結果處理:登記缺陷單並分類解決。
9. 移交測試:系統測試結束後可移交至現場測試。
10. 測試報告:生成測試報告及測試總結。
