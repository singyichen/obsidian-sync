...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"angle": 0,
			"x": -322.907096465475,
			"y": -229.21308622813683,
			"strokeColor": "#1e1e1e",
			"backgroundColor": "transparent",
			"width": 114.12597656250014,
			"height": 33.39000000000005,
			"seed": 1537117826,
			"groupIds": [],
			"frameId": null,
			"roundness": null,
			"boundElements": [],
			"updated": 1708074875002,
			"link": null,
			"locked": false,
			"fontSize": 9.275000000000018,
			"fontFamily": 3,
			"text": "• easy to use\n• multiple frameworks\n• auto-scales  ",
			"rawText": "• easy to use\n• multiple frameworks\n• auto-scales  ",
			"textAlign": "left",
